...
public class WebsiteListAdapter extends ArrayAdapter<Website>{
    ...
    private Integer[] starIcons = {R.drawable.star};

    public WebsiteListAdapter(Context context, ArrayList<Website> websites){
    ...
    public View getView(int position, View convertView, ViewGroup parent){
        ...
        starIcon.setImageResource(starIcons[0]);
        category_name.setText(website.getName());
